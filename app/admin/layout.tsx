...
const navItems = [
  ...
  { name: "Academic Setup", href: "/admin/academic", icon: Building2Icon },
  { name: "Course Allocations", href: "/admin/allocations", icon: BookOpenIcon },
  { name: "User Directory", href: "/admin/users", icon: UsersIcon },
  { name: "Bulk Import", href: "/admin/import", icon: FileSpreadsheetIcon },
];
        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-border">
          <Link href="/admin/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
              QRAttend <span className="text-xs px-1.5 py-0.5 rounded bg-primary/10 text-primary uppercase font-mono">Admin</span>
            </span>
          </Link>
          <button
            onClick={() => setMobileMenuOpen(false)}
      ...
      <div className="flex-1 flex flex-col lg:pl-64">
        ...
        <header className="h-16 border-b border-border bg-card/50 backdrop-blur-md sticky top-0 z-30 flex items-center justify-between px-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-semibold text-lg hidden sm:block">Administrative Control Center</h1>
          </div>
